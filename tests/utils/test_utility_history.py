...
class TestUtilityHistory(unittest.TestCase):
    ...
    def test_add_entry(self):
        self.history.add_entry(101, 1, "recA", 0.5)
        ...
        self.assertEqual(entry.item_id, 101)
    ...
    def test_get_history(self):
        self.history.add_entry(101, 1, "recA", 0.5)
        self.history.add_entry(102, 2, "recB", 0.7)
    ...
    def test_get_history_for_recommender(self):
        self.history.add_entry(101, 1, "recA", 0.5)
        self.history.add_entry(102, 2, "recB", 0.7)
        self.history.add_entry(103, 3, "recA", 0.9)
    ...
    def test_contains_item(self):
        ...
        self.history.add_entry(102, 2, "recB", 0.7)
        self.history.add_entry(103, 3, "recA", 0.9)
        self.assertTrue(self.history.contains_item(101))
        self.assertFalse(self.history.contains_item(110))

    def test_add_list_entry(self):
        self.history.add_entry(101, 1, "recA", 0.5)
        self.history.add_list_entry(2, "recB", 0.7)
        recB_entries = self.history.get_history_for_recommender("recB")
        self.assertEqual(len(recB_entries), 1)
        self.assertEqual(recB_entries[0].item_id, UtilityHistoryEntry.LIST_ENTRY)
