...
run_experiment(
    ...
    forget_interactions=False,      # Wipe all interaction history upon switching
    transfer_interactions=False    # Do not transfer any interactions to the new recommender
)